  ...
  // make sure all videos are stopped initially
  videos.forEach(v => {
    v.pause();
    v.currentTime = 0;
  });
  ...
  videos.forEach((video, i) => {
    video.addEventListener("ended", () => {
      ...
      // slide container
      group.style.transform = `translateX(-${index * videoWidth}px)`;

      // play next video AFTER slide starts
      setTimeout(() => {
...
let showingSignup = true; // start with Sign-Up
...
toggleLink.addEventListener("click", () => {
 ...
 document.addEventListener("DOMContentLoaded", function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener('submit', function(e){
      e.preventDefault(); // prevent page reload
      alert("Thank you for your message. Check your e-mail love.");
    });
  });
